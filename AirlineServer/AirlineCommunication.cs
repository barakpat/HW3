...
namespace AirlineServer
{
    class AirlineCommunication : IAirlineCommunication
    {
       ...
       // Dictionary<string, List<Flight> > airlineFlights = new Dictionary<string, List<Flight> >();
        ...
        private void updateLiveServers()
        {
            //TODO update the list of the live servers 
            // this should be automatically be generated by boris

            this.liveServers = this.distributer.getServers();
        }
